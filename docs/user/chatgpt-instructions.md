...
- Spark is a specialized ultra-fast choice for tiny latency-sensitive work when its separate research-preview quota is available. It is not the general small-worker default.
- GPT-5.4 Mini is the quota-saving standard choice for simple, bounded, high-volume work when maximizing included capacity matters more than Luna's stronger judgment.
