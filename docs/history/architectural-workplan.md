...
7. PatchBay keep/rewrite/delete ledger.
...
### Outcome A: Python PatchBay Absorbs CodexPro

PatchBay remains Python/FastAPI. CodexPro behavior is ported or copied conceptually into Python.
...
- whether PatchBay job execution benefits outweigh porting cost;
- how quickly the ChatGPT connector becomes strong;
- whether this path underuses CodexPro.

### Outcome B: TypeScript CodexPro Core Absorbs PatchBay Engine

The final repo becomes TypeScript-first. PatchBay job engine concepts are ported into the CodexPro-style runtime.
...
- risk of losing PatchBay's useful job boundaries;
...
### Outcome D: Wholesale Transplant/Rewrite Inside PatchBay Repo

Large parts of CodexPro are copied into PatchBay repo and PatchBay is reorganized around a new architecture.
...
| CodexPro source | PatchBay destination | Changes needed | License note | Tests |
| --- | --- | --- | --- | --- |
...
- PatchBay service boundaries are better;
- source code depends on incompatible package structure;
- direct copy would create duplicated policy.

Required record:

| Behavior | Source evidence | New PatchBay service | Compatibility requirements | Tests |
| --- | --- | --- | --- | --- |
...
| Old PatchBay behavior | CodexPro behavior | New design | Deleted code | Tests |
| --- | --- | --- | --- | --- |
...
- Every PatchBay rewrite/delete has reason and replacement.
...
- What exact parts of PatchBay are kept, rewritten, deleted, or replaced?
