...
If this project receives API credits through the Codex for Open Source program, the credits will be used only for open-source maintainer workflows on repositories I own or maintain.

## Planned Uses

1. Codex-assisted pull request review for owned public repositories.
2. Maintainer automation examples using Codex and MCP.
3. Test generation and regression review for `codex-mcp-wrapper`.
...
8. Evaluation of MCP tool descriptions and tool-selection behavior.
