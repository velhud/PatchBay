...
7. verify `codex_worker_status`, `codex_worker_wait`, and `codex_worker_list` return useful compact team status / `team_report`, including all-repo unscoped visibility, minimum-cadence wait behavior, and soft cooldown fields for rapid polling;
