...
from security import redact_text, validate_allowed_path
...
class WorkspaceContext:
    """CodexPro-style workspace inspection with wrapper policy boundaries."""
    ...
    def export_context(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        title = str(args.get("title") or "Codex MCP Wrapper Context Bundle")
        markdown = f"# {title}\n\n{context['text']}"
